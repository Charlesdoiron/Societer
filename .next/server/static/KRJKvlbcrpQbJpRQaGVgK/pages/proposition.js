...
module.exports = __webpack_require__("t+Wy");
...
const Accordion = props => {
  ...
  } = Object(external_react_["useState"])("engagement-societal");

  const handleExpertise = slug => {
    setExpertiseActive(slug);
  };

  return __jsx(space["a" /* FatWrapper */], {
    noWrapperOnMobile: true
  }, __jsx(Container, null, __jsx(Titles, null, __jsx(space["a" /* FatWrapper */], {
    noWrapperDesktop: true
  }, __jsx(ExpertiseSubtitle, null, props.subTitle)), props.content.map(el => {
    return __jsx(external_react_default.a.Fragment, null, __jsx(space["a" /* FatWrapper */], {
      noWrapperDesktop: true
    }, __jsx(typos["e" /* ExpertiseTitle */], {
      className: el.slug === expertiseActive && "isActive",
      onMouseEnter: () => handleExpertise(el.slug),
      onTouchStart: () => handleExpertise(el.slug),
      key: el.title
    }, el.title)), el.slug === expertiseActive && __jsx(ShowOnMobile, null, __jsx(external_react_collapse_["Collapse"], {
      isOpened: el.slug === expertiseActive
    }, __jsx(CollapseContent, {
      className: "no--wrapper"
    }, __jsx(ExpertiseSubtitleCollapse, null, props.subTitleTwo), __jsx(typos["g" /* Labor */], null, el.description)))));
  })), __jsx(Content, null, __jsx(HideOnMobile, null, __jsx(ExpertiseSubtitle, null, props.subTitleTwo), props.content.map(el => {
    if (el.slug === expertiseActive) {
      return __jsx(typos["g" /* Labor */], null, el.description);
    }
  })))));
};
...
const Container = external_styled_components_default.a.div.withConfig({
  ...
  `);
const ExpertiseSubtitle = external_styled_components_default()(typos["m" /* SmallSubtitle */]).withConfig({
  displayName: "accordion__ExpertiseSubtitle",
  componentId: "sc-1s6icfm-1"
})(["margin-bottom:25px;", ""], props => props.theme.medias.medium`
    margin-bottom: 10px;
  `);
const ExpertiseSubtitleCollapse = external_styled_components_default()(ExpertiseSubtitle).withConfig({
  displayName: "accordion__ExpertiseSubtitleCollapse",
  componentId: "sc-1s6icfm-2"
})(["color:", ";"], props => props.theme.colors.white);
const ShowOnMobile = external_styled_components_default.a.div.withConfig({
...
const HideOnMobile = external_styled_components_default.a.div.withConfig({
  displayName: "accordion__HideOnMobile",
  componentId: "sc-1s6icfm-6"
})(["display:block;", ""], props => props.theme.medias.medium`
  display:none;
`);
const CollapseContent = external_styled_components_default.a.div.withConfig({
...
// CONCATENATED MODULE: ./pages/proposition.js

var proposition_jsx = external_react_default.a.createElement;
...
function Proposition() {
  ...
  return proposition_jsx(external_react_default.a.Fragment, null, proposition_jsx(head_default.a, null, proposition_jsx("title", null, "Societer | la Proposition")), proposition_jsx(space["b" /* Wrapper */], null, proposition_jsx(FirstPart, null, proposition_jsx(typos["d" /* Chapeau */], null, proposition.chapeau), proposition_jsx(typos["g" /* Labor */], null, proposition.firstPartLabor))), proposition_jsx(SecondPart, null, proposition_jsx(space["b" /* Wrapper */], {
    isWhite: true
  }, proposition_jsx(typos["n" /* Subtitle */], null, proposition.secondPartSubtitle), proposition_jsx(typos["f" /* FatTitle */], null, proposition.secondPartFatTitle)), proposition_jsx(Img, {
    src: "images/proposition/proposition_img.jpg",
    alt: ""
  }), proposition_jsx(accordion, {
...
/* harmony default export */ var pages_proposition = __webpack_exports__["default"] = (Proposition);
...
const SecondPart = external_styled_components_default.a.div.withConfig({
  ...
  `, props => props.theme.colors.black, props => props.theme.medias.medium`
     ...
     margin-bottom: 60px;
    `);
const ThirdPart = external_styled_components_default.a.div.withConfig({
